...
class Config:
    ...
    """
    local_path = '/home/seel/Documents/leetcode'
    # solution of leetcode
    #github_leetcode_url = 'https://github.com/hey-bruce/algorithms_and_oj/blob/master/leetcode-algorithms/'
    github_leetcode_url = 'https://github.com/SilvesterHsu/leetcode/blob/master/leetcode-algorithms/'
            ...
            for folder in folders:
                ...
                for _, _, files in os.walk(os.path.join(oj_algorithms, folder)):
                    ...
                    for item in files:
                        ...
                        elif item.endswith('.jl'):
                            complete_info.solved['julia'] += 1
                            folder_url = folder.replace(' ', "%20")
                            folder_url = os.path.join(folder_url, item)
                            folder_url = os.path.join(Config.github_leetcode_url, folder_url)
                            self.table_item[folder[:3]].julia = '[Julia]({})'.format(folder_url)
...
class Readme:
    ...
    def create_leetcode_readme(self, table_instance):
        ...
        with open(file_path, 'a') as f:
            ...
            f.write('| ID | Title | Difficulty | Python | Julia |\n')
            f.write('|:---:' * 5 + '|\n')
            ...
            for index in table:
                ...
                data = {
                    ...
                    'julia': item.julia if item.julia else 'To Do'
                }
                line = '|{id}|{title}|{difficulty}|{python}|{julia}|\n'.format(**data)
                f.write(line)
